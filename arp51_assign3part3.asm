...
#                if (*hopPtr22 != anchor) goto endI_PALA;
			lw $t0, 0($t2)
			#lw $t9, 0($sp) #$t9 is a temp. to save $s2 from stack  #CHECK $s2?
			bne $t0, $s2, endI_PALA
begI_PALA:#//    {
...
#             endPtr2 = intArr + (*usedPtr);
			lw $t0, 0($a1) #$ hold value of usedPtr ($a1)
			sll $t0, $t0, 2 #$v1 = $v1 * 4
			add $s2, $t0, $a0 #endPtr2 = (*usedPtr X 4) + intArr
